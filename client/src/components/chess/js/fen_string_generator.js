 ...
 */
function generateFENString(board, boardHistory, halfMoves) {
    let fenString = "";
    fenString = addBoardToFENString(fenString, board);
 ...
 */
function addBoardToFENString(fenString, board) {
 ...
 */
function addTurnToFEN(fenString, boardHistory) {
 ...
 * @returns {*} the updated fen string.
 */
function addCastleRights(fenString, board) {
 ...
 */
function addEnPassantMoves(fenString, board) {
    ...
    if (lastMove !== undefined) {
        ...
        if (getField(newField, board).piece.type === "pawn") {
 ...
 * @returns {*} the updated fen string.
 */
function addHalfMoves(fenString, halfMoves) {
    fenString += " " + halfMoves;
    return fenString;
}
 ...
 * @returns {*} the updated fen string.
 */
function addMoveCounter(fenString, boardHistory) {
